...
const DEFAULT_API_URL: &str = "https://api.kanbancrew.com";
...
fn show_disclaimer() {
    ...
    println!();
    println!("Full terms and conditions and privacy policy: https://kanbancrew.com/terms");
    println!();
