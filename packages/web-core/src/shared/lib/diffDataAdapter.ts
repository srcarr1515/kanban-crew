...
/**
 * Maps kanban-crew's DiffChangeKind to pierre/diffs ChangeTypes.
 *
 * Mapping:
 * - 'added' → 'new'
 * - 'deleted' → 'deleted'
...
/**
 * Transforms a kanban-crew Diff to pierre/diffs FileDiffMetadata.
 *
 * Uses parseDiffFromFile from @pierre/diffs to generate the diff metadata
 * from old and new file contents.
 *
 * @param diff - The kanban-crew Diff object
