---
title: "Remote Access"
description: "Access your local Kanban Crew instance from another device"
---

Remote Access allows you to access a host instance of Kanban Crew from another device, like your mobile phone.

# 1. Launch Kanban Crew on the host device

Make sure you've started Kanban Crew and logged in.
...
# 3. Log into Kanban Crew cloud

On the client device where you'd now like to access your host machine from, navigate to [cloud.kanbancrew.com](https://cloud.kanbancrew.com) in a browser and log in.
...
<Frame>
  <img style={{maxHeight: "500px"}} src="/images/remote-access-cloud-mobile.png" alt="Kanban Crew cloud remote access page on mobile showing a paired host and workspaces" />
</Frame>
