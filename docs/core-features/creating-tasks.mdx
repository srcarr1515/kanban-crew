...
<Tip>
For detailed setup instructions and examples, see the [Kanban Crew MCP Server](/integrations/kanban-crew-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Kanban Crew project based on this description.
