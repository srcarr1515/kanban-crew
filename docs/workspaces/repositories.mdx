...
When you add a repository to a workspace, Kanban Crew creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.kanban-crew-workspaces` directory (configurable in Settings).
</Accordion>
