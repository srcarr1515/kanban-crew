...
description: "Run Kanban Crew Cloud locally"
---

This guide walks you through setting up a local Kanban Crew Cloud instance for development and testing.
...
3. Fill in the details:
   - **Application name**: Kanban Crew Local
...
KANBANCREW_REMOTE_JWT_SECRET=<paste_your_generated_secret_here>
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the Kanban Crew Cloud login page.
...
When running locally, the server automatically starts background workers for the [job scheduler](/core-features/scheduled-jobs) and PR monitor. These poll every 60 seconds and use minimal resources. No additional configuration is needed for local development.
