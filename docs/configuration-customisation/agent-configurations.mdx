...
<Info>
Agent profiles are used throughout Kanban Crew wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Kanban Crew saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Kanban Crew for your coding agents
</Card>

<Card title="Kanban Crew MCP Server" icon="plug" href="/integrations/kanban-crew-mcp-server">
  Connect external MCP clients to Kanban Crew's MCP server
</Card>
</CardGroup>
