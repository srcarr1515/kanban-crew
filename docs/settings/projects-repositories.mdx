...
<Tip>
The dev server must output its URL (e.g., `http://localhost:3000`) to stdout for Kanban Crew to detect and display it in the preview panel.
</Tip>
...
Run your scripts manually in a terminal before configuring them in Kanban Crew to ensure they work correctly.
</Accordion>
</AccordionGroup>
