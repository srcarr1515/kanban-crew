...
## Authentication
Authenticate and configure CCR outside of Kanban Crew. Follow the instructions on the CCR GitHub repo:
...
## Configure Kanban Crew

Kanban Crew does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Kanban Crew

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Kanban Crew" />
</Frame>

## Using CCR in Kanban Crew
