...
icon: https://www.kanbancrew.com/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Kanban Crew, you must first authenticate:
...
Droid supports several configuration options in Kanban Crew:
...
These options can be configured when creating agent configurations in Kanban Crew.
