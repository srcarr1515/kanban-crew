...
Kanban Crew Cloud lets you collaborate with your team in real-time. Your data syncs to the cloud, so everyone sees the same projects, issues, and updates.

<Info>
**Already using Kanban Crew locally?** Cloud uses the same interface you're familiar with. The difference is your data syncs to the cloud and you can invite team members.
</Info>

## Step 1: Launch Kanban Crew

If you haven't already, start Kanban Crew:
...
<Step title="Authorise the application">
  You'll be redirected to GitHub or Google. Sign in if needed, then click **Authorize** or **Allow** to grant Kanban Crew access.

  <Info>
  Kanban Crew only requests access to your basic profile (name, email, avatar). It cannot access your private repositories or post on your behalf.
  </Info>
</Step>

<Step title="Return to Kanban Crew">
...
Both appear in the same Kanban Crew interface. Local projects show in one section, Cloud projects in another.
