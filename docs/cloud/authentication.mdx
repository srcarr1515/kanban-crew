...
Kanban Crew Cloud uses OAuth authentication, allowing you to sign in with your existing GitHub or Google account instead of creating a new password.
...
OAuth is a secure way to sign in to applications using accounts you already have. When you click "Sign in with GitHub", you're redirected to GitHub to confirm you want to allow Kanban Crew access. GitHub then tells Kanban Crew who you are, without Kanban Crew ever seeing your GitHub password.
</Info>
...
<Step title="Authorise on Provider">
  ...
  Click **Authorize** (GitHub) or **Allow** (Google) to grant Kanban Crew access.
</Step>

<Step title="Redirected Back">
  After authorising, you're automatically redirected back to Kanban Crew and signed in.
</Step>
</Steps>

### What Kanban Crew Can Access

When you authorise Kanban Crew, it only requests minimal permissions:
...
2. Find "Kanban Crew Cloud" and revoke access
...
1. Sign out of Kanban Crew
2. Go to the provider's website (github.com or google.com)
3. Sign out there
4. Return to Kanban Crew and sign in - you'll be prompted to log in to the provider

## Security Best Practices

<CardGroup cols={2}>
<Card title="Use a strong provider password" icon="lock">
  Your Kanban Crew security depends on your GitHub/Google account security. Use a strong, unique password.
</Card>
...
2. If you're part of a GitHub organisation with app restrictions, ask your admin to approve Kanban Crew
</Accordion>
...
4. Return to Kanban Crew and sign in
</Accordion>
...
**Problem:** You revoked Kanban Crew's access on GitHub/Google and now can't sign in.
