---
title: "Kanban Crew Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

## What is Kanban Crew Cloud?

**Kanban Crew Cloud** adds team collaboration to Kanban Crew. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Kanban Crew interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Kanban Crew installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Kanban Crew** as usual with `npx kanban-crew`
...
Think of it as your company or team in Kanban Crew.
...
- Review code directly in Kanban Crew
- Track PR status

## Getting Started

<Steps>
<Step title="Run Kanban Crew">
  ```bash
  npx kanban-crew
  ```
</Step>
