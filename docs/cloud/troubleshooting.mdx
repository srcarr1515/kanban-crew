...
description: "Solutions for common issues with Kanban Crew Cloud"
---

This page covers common issues you might encounter with Kanban Crew Cloud and how to resolve them.
...
4. Return to Kanban Crew and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Kanban Crew (`npx kanban-crew`)
</Accordion>
...
1. **Check existing issues:** [github.com/srcarr1515/kanban-crew/issues](https://github.com/srcarr1515/kanban-crew/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/srcarr1515/kanban-crew/issues/new">
